...
const Header = () => {
    return (
        <div className={`grid grid-cols-12 ${styles.mainContainer}`}>
            ...
            <div className={`flex items-center justify-center col-span-3 ${styles.searchContainer}`}>
                <Image src="/ic_lens.svg" height={15} width={15}/>
                <input type="text" className={styles.searchInput} placeholder="Buscar..."/> 
            </div>
            <div className={`flex items-center justify-center col-span-2 ${styles.settingsContainer}`}>
                <Image src="/ic_gear.svg" height={15} width={15}/>
                <h2 className={styles.title}>Administración</h2>
                <p className={styles.notification}>2</p>
            </div>
            <div className={`flex items-center justify-center col-span-1 ${styles.employmentContainer}`}>
            ...
            <div className={`flex items-center justify-center col-start-10 col-end-11 ${styles.cvContainer}`}>
                <Image src="/ic_cv.svg" height={15} width={15}/>
                <h2 className={styles.title}>Mi CV</h2>
            </div>
            <div className={`flex items-center justify-center col-start-11 col-end-13  ${styles.profileContainer}`}>
                <Image src="/ic_cv.svg" height={15} width={15}/>
